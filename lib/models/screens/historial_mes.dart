...
class _PantallaHistorialMesesState extends State<PantallaHistorialMeses> {
  ...
  Future<void> _cargarHistorial() async {
    ...
    if (datosGuardados != null) {
      ...
      setState(() {
        // Lo damos vuelta (reversed) para que el mes más reciente aparezca arriba
  ...
  Future<void> _borrarHistorialCompleto() async {
    ...
    final confirmar = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Esta acción eliminará todos los registros de meses anteriores. No se puede deshacer.',
        ),
        actions: [
          TextButton(
